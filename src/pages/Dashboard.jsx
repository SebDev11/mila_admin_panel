...
export function Dashboard() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 backdrop-blur-xl rounded-2xl p-6 border border-white/20 shadow-2xl">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-white mb-3 drop-shadow-lg">Dashboard</h1>
            <p className="text-blue-200 text-lg font-medium mb-4">Overview of your email marketing performance</p>
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-green-400 rounded-full animate-pulse shadow-lg"></div>
                <span className="text-green-300 text-sm font-semibold">System Operational</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-purple-300 text-sm font-semibold">Live Analytics</span>
              </div>
            </div>
          </div>
          <div className="text-right">
            <div className="text-3xl font-bold text-white drop-shadow-lg">{stats.emailsSent.toLocaleString()}</div>
            <div className="text-sm text-blue-200 font-semibold">Total Emails Sent</div>
          </div>
        </div>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="p-6 bg-gradient-to-br from-blue-500/50 to-indigo-500/50 border-blue-500/70 shadow-xl backdrop-blur-xl 
          transform hover:scale-105 transition-all duration-300 hover:shadow-blue-500/40">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-5 h-5 bg-blue-400 rounded-full shadow-lg animate-pulse"></div>
            <div className="text-white text-sm font-semibold">Total Emails Sent</div>
          </div>
          <div className="text-4xl font-bold text-white mb-2 drop-shadow-lg">{stats.emailsSent.toLocaleString()}</div>
          <div className="text-white/90 text-xs font-medium mb-3">All time</div>
        </Card>
        <Card className="p-6 bg-gradient-to-br from-green-500/50 to-emerald-500/50 border-green-500/70 shadow-xl 
          backdrop-blur-xl transform hover:scale-105 transition-all duration-300 hover:shadow-green-500/40">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-5 h-5 bg-green-400 rounded-full shadow-lg animate-pulse"></div>
            <div className="text-white text-sm font-semibold">Active Campaigns</div>
          </div>
          <div className="text-4xl font-bold text-white mb-2 drop-shadow-lg">{stats.activeCampaigns}</div>
          <div className="text-white/90 text-xs font-medium mb-3">Currently running</div>
        </Card>
        <Card className="p-6 bg-gradient-to-br from-purple-500/50 to-violet-500/50 border-purple-500/70 shadow-xl 
          backdrop-blur-xl transform hover:scale-105 transition-all duration-300 hover:shadow-purple-500/40">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-5 h-5 bg-purple-400 rounded-full shadow-lg animate-pulse"></div>
            <div className="text-white text-sm font-semibold">Engaged Leads</div>
          </div>
          <div className="text-4xl font-bold text-white mb-2 drop-shadow-lg">{stats.engagedLeads.toLocaleString()}</div>
          <div className="text-white/90 text-xs font-medium mb-3">Interacted with emails</div>
        </Card>
        <Card className="p-6 bg-gradient-to-br from-yellow-500/50 to-orange-500/50 border-yellow-500/70 shadow-xl 
          backdrop-blur-xl transform hover:scale-105 transition-all duration-300 hover:shadow-yellow-500/40">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-5 h-5 bg-yellow-400 rounded-full shadow-lg animate-pulse"></div>
            <div className="text-white text-sm font-semibold">System Health</div>
          </div>
          <div className="text-4xl font-bold text-white mb-2 drop-shadow-lg">{stats.systemHealth}</div>
          <div className="text-white/90 text-xs font-medium mb-3">Current status</div>
        </Card>
      </div>
      ...
      <Card className="p-6 bg-slate-800/40 border-slate-600/30 shadow-xl">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white">Email Engagement This Week</h3>
        ...
        {chartData.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <div className="text-slate-300 text-lg font-medium mb-2">No Engagement Data</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="p-6 bg-slate-800/40 border-slate-600/30 shadow-xl">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white">Sent Emails by Campaign</h3>
          ...
          <div className="overflow-hidden rounded-lg border border-slate-600/30">
            <table className="min-w-full divide-y divide-slate-600/30">
              <thead className="bg-slate-700/40">
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-blue-200 uppercase tracking-wide">Campaign</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-blue-200 uppercase tracking-wide">Sent Emails</th>
              </tr>
            </thead>
              ...
              {breakdown.byCampaign.length === 0 ? (
                  ...
                  breakdown.byCampaign.map((row, idx) => (
                    <tr key={row.name || idx} className="hover:bg-slate-700/30 transition-colors duration-200">
                      <td className="px-4 py-3 text-white text-sm font-medium">{row.name || 'Unknown'}</td>
        ...
        <Card className="p-6 bg-slate-800/40 border-slate-600/30 shadow-xl">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white">Sent Emails by User</h3>
              <p className="text-blue-200 text-xs">Last 7 days performance</p>
            </div>
          </div>
          <div className="overflow-hidden rounded-lg border border-slate-600/30">
            <table className="min-w-full divide-y divide-slate-600/30">
              <thead className="bg-slate-700/40">
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-blue-200 uppercase tracking-wide">User (Sender Email)</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-blue-200 uppercase tracking-wide">Sent Emails</th>
              </tr>
            </thead>
              <tbody className="divide-y divide-slate-600/30 bg-slate-800/20">
              {breakdown.byUser.length === 0 ? (
                ...
                breakdown.byUser.map((row, idx) => (
                    <tr key={row.email || idx} className="hover:bg-slate-700/30 transition-colors duration-200">
                      <td className="px-4 py-3 text-white text-sm font-medium">{row.email || 'Unknown'}</td>
                      <td className="px-4 py-3">
