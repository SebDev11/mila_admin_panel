    ...
    <div className="p-6 max-w-9xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <h1 className="text-3xl font-bold text-white mb-2">Billing Management</h1>
          <p className="text-blue-200">Manage user billing and subscription plans</p>
        </div>
        <div className="flex items-center gap-4">
          <div className="text-right">
            <div className="text-2xl font-bold text-white">{billingData.length}</div>
      ...
      <Card className="p-0 overflow-hidden bg-slate-800/60 border-slate-600/50 backdrop-blur-sm shadow-xl">
        <div className="p-8 border-b border-slate-600/50 bg-gradient-to-r from-slate-700/40 to-slate-600/30">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">User Billing Overview</h2>
              <p className="text-blue-200 text-sm mt-1">View and manage user billing information and subscription details</p>
            </div>
          </div>
        </div>
        <div className="p-8">
          <div className="overflow-hidden rounded-2xl border border-slate-600/30 shadow-xl">
            <table className="min-w-full divide-y divide-slate-600/30">
              <thead className="bg-gradient-to-r from-slate-700/60 to-slate-600/50">
                <tr>
                  {columns.map((col) => (
                    <th key={col.key} className="px-6 py-4 text-left text-sm font-bold text-blue-200 uppercase tracking-wide">
                      {col.label}
                    </th>
                  ))}
                </tr>
              ...
              <tbody className="divide-y divide-slate-600/30 bg-slate-800/20">
                {billingData.length === 0 ? (
                  <tr>
                    <td colSpan={columns.length} className="text-center text-slate-400 py-12">
                      <div className="flex flex-col items-center gap-4">
                        ...
                        <div>
                          <div className="text-slate-300 text-lg font-medium mb-2">No User Data</div>
                          <div className="text-slate-400 text-sm">No billing information available at the moment</div>
                        </div>
                      </div>
                    </td>
                  </tr>
                        ...
                        <td key={col.key} className="px-6 py-4">
                          {col.key === 'name' ? (
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <div className="text-white font-semibold">{row.name || 'Unknown User'}</div>
                                <div className="text-slate-400 text-xs">User ID: {row._id?.slice(-8) || 'N/A'}</div>
                              </div>
                            </div>
                          ) : col.key === 'plan' ? (
                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold ${
                              ...
                              {row.plan ? row.plan.charAt(0).toUpperCase() + row.plan.slice(1) : 'Free'}
                            </span>
                          ) : col.key === 'role' ? (
                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold ${
      ...
      <Card className="p-0 overflow-hidden bg-slate-800/60 border-slate-600/50 backdrop-blur-sm shadow-xl">
        <div className="p-8 border-b border-slate-600/50 bg-gradient-to-r from-slate-700/40 to-slate-600/30">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200 text-sm mt-1">Create and manage subscription plans for your users</p>
            </div>
          </div>
        </div>
        <div className="p-8">
          <form onSubmit={handleAddPlan} className="mb-8 bg-gradient-to-br from-slate-700/50 to-slate-600/40 p-8 rounded-2xl border border-slate-500/40 shadow-2xl backdrop-blur-sm">
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">Configure a new subscription plan with custom settings</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 group relative h-full flex flex-col">
              ...
              <label className="block text-sm font-bold mb-4 text-white flex items-center gap-3 relative z-10">
                <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-xl shadow-blue-500/30 border-2 border-blue-400/50">
                  <span className="text-sm font-black text-white">1</span>
                </div>
                <div>
                  <div className="text-white text-base font-bold">Plan Name</div>
              ...
              <div className="relative z-10 flex-1 flex flex-col">
                <div className="relative flex-1">
                  <input 
                    ...
                    required 
                    className="w-full bg-gradient-to-r from-slate-800/80 to-slate-700/80 border-3 border-blue-400/80 rounded-2xl px-6 py-5 text-white text-lg font-semibold placeholder-gray-300 focus:border-blue-400 focus:ring-6 focus:ring-blue-400/30 transition-all duration-500 shadow-2xl hover:shadow-blue-500/25 group-hover:border-blue-400 group-hover:scale-[1.02] backdrop-blur-sm" 
                ...
                <div className="mt-4 p-4 bg-gradient-to-r from-blue-500/15 to-indigo-500/15 rounded-xl border border-blue-400/40 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-blue-200 text-sm font-semibold">Unique identifier for the plan</div>
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-600/30 shadow-xl">
          <table className="min-w-full divide-y divide-slate-600/30">
            <thead className="bg-gradient-to-r from-slate-700/60 to-slate-600/50">
              <tr>
                <th className="px-6 py-4 text-left text-sm font-bold text-blue-200 uppercase tracking-wide">
                  <div className="flex items-center gap-2">
                ...
                <tr key={plan.name} className="hover:bg-slate-700/30 transition-all duration-300 group">
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-white font-semibold text-base capitalize">{plan.name}</div>
                      ...
                      <div className="flex-1">
                        <div className="relative">
                          <input
                            ...
                            className="w-full bg-slate-800/70 border-2 border-slate-500/50 rounded-xl px-4 py-3 text-white text-sm font-medium focus:border-green-400/80 focus:ring-4 focus:ring-green-400/20 transition-all duration-300 shadow-lg hover:shadow-green-500/10"
